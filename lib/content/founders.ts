...
export const FOUNDERS: Founder[] = [
  ...
  },
  {
    name: "Thomas Llamzon",
    role: "Co-Founder",
    bio: "BSc, Computer Science, Western University, 4x Dean's Honour List. Software engineering, cybersecurity (SOC) operations. Architecting and building Pacific Edge's infrastructure and solutions.",
  },
]
