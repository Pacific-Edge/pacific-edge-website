...
/* ─────────────────────────────────────────────────────────────────────────
   LIGHT PILLAR — WebGL raymarched light beam (React Bits, adapted to TS).
   Renders a rotating column of light with a top→bottom colour gradient.
   Intended as a full-bleed background layer behind foreground content.
   ──────────────────────────────────────────────────────────────────────── */
...
export default function LightPillar({
  ...
  bottomColor = LIGHT_PILLAR_BOTTOM_COLOR,
  intensity = 1.0,
  rotationSpeed = 0.3,
  interactive = false,
  className = "",
