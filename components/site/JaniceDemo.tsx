...
export default function JaniceDemo() {
  useEffect(() => {
    ...
    const badge = (text: string) => {
      ...
      const i = document.createElement("span"); i.className = "chat-badge-ico"
      i.innerHTML = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#4af0c0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.27"/></svg>'
