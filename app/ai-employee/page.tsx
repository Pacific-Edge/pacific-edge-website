...
<div className="sl sl-c">The big picture</div>
<h2>Never Miss Another<br /><span className="a">Call, Booking, Or Review.</span></h2>
<p>While you run your business, Janice quietly catches everything that used to slip through, day, night, and weekend.</p>
</div>
</div>
</section>
...
<div className="icard feat reveal d1"><div className="icard-ico"><Phone size={20} strokeWidth={1.75} /></div><h3>Answers every call</h3><p>Picks up, or texts back a missed call in seconds, so a new customer never hits voicemail and calls the competitor instead.</p><span className="tag">Calls</span></div>
<div className="icard feat reveal d2"><div className="icard-ico"><MessageCircle size={20} strokeWidth={1.75} /></div><h3>Replies on every channel</h3><p>Phone, SMS, Instagram, web chat, and email, all answered instantly from one place, in your tone of voice.</p><span className="tag">Messaging</span></div>
<div className="icard feat reveal d3"><div className="icard-ico"><Calendar size={20} strokeWidth={1.75} /></div><h3>Books &amp; reschedules</h3><p>Offers real open times and drops the booking straight into the calendar and tools you already use.</p><span className="tag">Booking</span></div>
<div className="icard feat reveal d1"><div className="icard-ico"><RotateCcw size={20} strokeWidth={1.75} /></div><h3>Fills cancellations</h3><p>The second a spot frees up, Janice offers it to your waitlist and books the first to say yes. No empty chairs or tables.</p><span className="tag">Recovery</span></div>
...
<div className="icard feat reveal d3"><div className="icard-ico"><Star size={20} strokeWidth={1.75} /></div><h3>Follows up &amp; earns reviews</h3><p>Chases quotes and treatment plans, then asks your happiest customers for a review at just the right moment.</p><span className="tag">Follow-up</span></div>
</div>
</div>
</section>
...
<section id="how">
<div className="wrap">
<div className="sl reveal">A Closer Look</div>
<h2 className="st reveal d1">How Janice <span className="a">Earns Her Keep.</span></h2>
<p className="sd reveal d2">A few of the moments where Janice quietly saves the day, every single day.</p>
...
<h3>Never A Missed <span className="a">Opportunity.</span></h3>
<p>Slammed, closed, or mid-job, it does not matter. Janice answers or texts back in seconds, captures what the customer needs, and books it before they move on.</p>
...
<p>A cancellation used to mean an empty slot and lost revenue. Now the moment it happens, Janice offers the opening to your waitlist and rebooks it, often within minutes.</p>
<ul className="frow-list">
...
<div className="show-step reveal d3"><div className="show-step-n">2</div><div><h4>Janice replies and books it</h4><p>She answers the question, offers a real time, and confirms, in a warm back-and-forth.</p></div></div>
...
<span><b><Settings size={13} strokeWidth={2.5} /> Custom-built</b>, not a template</span>
<span><b><MapPin size={13} strokeWidth={2.5} /> Vancouver team</b>, that gets local business</span>
<span><b><Plug size={13} strokeWidth={2.5} /> Plugged in</b>, to your phone, calendar &amp; tools</span>
</div>
</div>
</section>
...
<div className="sl reveal sl-c">Everywhere You Are</div>
...
<details className="faq-item reveal"><summary>Is Janice a real person?<span className="faq-ico"></span></summary><div className="faq-body">No. Janice is the friendly name for your AI employee from Pacific Edge AI. She handles calls and messages automatically, and hands anything sensitive to your team.</div></details>
<details className="faq-item reveal"><summary>Will Janice sound like a robot?<span className="faq-ico"></span></summary><div className="faq-body">No. We train her on your business and your tone, so replies feel like they came from a helpful member of your team. You approve the voice before she ever goes live.</div></details>
