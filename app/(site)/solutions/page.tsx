        ...
        <div className="container-x">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10">
            {SOLUTION_PILLARS.map((pillar, i) => (
              ...
              >
                <div className="shrink-0 w-24 h-24 rounded-2xl bg-midnight-900 flex flex-col items-center justify-center text-white-50">
                  <span className="font-display text-2xl font-bold leading-none">
                    {PILLAR_VISUALS[i].stat}
                  </span>
                  <span className="font-ui text-[10px] uppercase tracking-widest text-white-50/50 mt-1">
                    {PILLAR_VISUALS[i].sub}
                  </span>
                </div>
                <div>
                  <p className="eyebrow text-ash-500 mb-3">{PILLAR_VISUALS[i].label}</p>
                  <h2 className="font-display text-xl sm:text-2xl text-midnight-900 mb-3">
                    {pillar.title}
                  </h2>
